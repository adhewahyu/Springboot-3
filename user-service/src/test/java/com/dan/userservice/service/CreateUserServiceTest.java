...
import com.dan.userservice.service.user.CreateUserService;
...
class CreateUserServiceTest {
    ...
    void doTest_failedValidation(){
        ReflectionTestUtils.setField(createUserService, "validateUserService", validateUserService);
        ...
        try{
            createUserService.execute(CreateUserRequest.builder()
                    .username(null)
                    .firstName("test")
                    .middleName("test")
                    .lastName("test")
    ...
    void doTest_success(){
        ReflectionTestUtils.setField(createUserService, "validateUserService", validateUserService);
        ReflectionTestUtils.setField(createUserService, "createTaskAdaptor", createTaskAdaptor);
        Mockito.when(validateUserService.execute(Mockito.any(ValidateUserRequest.class)))
        ...
        ValidationResponse actualResponse = createUserService.execute(CreateUserRequest.builder()
                .username("test")
                .firstName("test")
                .middleName("test")
                .lastName("test")
