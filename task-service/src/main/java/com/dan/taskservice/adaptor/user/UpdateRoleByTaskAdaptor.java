...
import com.dan.taskservice.model.request.UpdateRoleRequest;
...
public class UpdateRoleByTaskAdaptor {

    @Value("${integration.user.updateRoleByTaskUrl}")
    private String url;
    ...
    public void execute(UpdateRoleRequest updateRoleRequest){
        log.info("url = {}", url);
        webClientBasic
                .method(HttpMethod.POST)
                .uri(url)
                .headers(this::getHttpHeaders)
                .body(Mono.just(updateRoleRequest), UpdateRoleRequest.class)
                .retrieve()
