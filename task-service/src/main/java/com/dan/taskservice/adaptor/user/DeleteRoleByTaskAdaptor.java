...
public class DeleteRoleByTaskAdaptor {

    @Value("${integration.user.deleteRoleByTaskUrl}")
    private String url;
    ...
    public void execute(FindByIdRequest findByIdRequest){
        log.info("url = {}", url);
        webClientBasic
                .method(HttpMethod.POST)
                .uri(url)
                .headers(this::getHttpHeaders)
                .body(Mono.just(findByIdRequest), FindByIdRequest.class)
                .retrieve()
