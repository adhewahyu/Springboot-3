...
INSERT INTO public.permissions (id, access_level, api, category, description, "name", parent_id, status)
VALUES('0f324f23-61c6-49d3-a3f6-edb224284437', 1, '', 'user', '[PARENT]-Delete User', 'Delete User', '6cf53724-cecb-4145-89d8-03ee33310694', 1);
INSERT INTO public.permissions (id, access_level, api, category, description, "name", parent_id, status)
...
INSERT INTO public.permissions (id, access_level, api, category, description, "name", parent_id, status)
VALUES('d66be642-a30d-4f33-bd95-73cae189c57b', 1, '', 'user', '[PARENT]-View User', 'View User', '6cf53724-cecb-4145-89d8-03ee33310694', 1);
INSERT INTO public.permissions (id, access_level, api, category, description, "name", parent_id, status)
...
INSERT INTO public.permissions (id, access_level, api, category, description, "name", parent_id, status)
VALUES('894f8bcd-b361-45c4-a37f-29fd61bdbd35', 1, '', 'role', '[PARENT]-View Role', 'View Role', '57a840e6-3ba5-4c7d-a3ef-ec8931772a03', 1);
INSERT INTO public.permissions (id, access_level, api, category, description, "name", parent_id, status)
